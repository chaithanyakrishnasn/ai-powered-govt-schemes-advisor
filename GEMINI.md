...
Chat fixed — real conversational AI using Gemini with intent detection. Scheme search triggered only when relevant. Project is portfolio-ready. Phase 6.3 (optional weekly re-scrape cron) is the only remaining item.
...
- **Total phases:** 6
- **Total steps:** ~20
- **Backend:** FastAPI + 3-stage matching pipeline + multilingual
- **Frontend:** Next.js 15 + 3 locales + SSE streaming
- **Data:** 334 schemes, 1763 rules, 768-dim embeddings
- **Tests:** 229 backend + frontend lint/build passing
